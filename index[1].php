...
<head>
  ...
  <title>localhost / 127.0.0.1 / student | phpMyAdmin 5.2.1</title>
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=student&table=exam">
    `student`.`exam`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=student&table=employee">
    `student`.`employee`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=student&table=person">
    `student`.`person`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=student&table=student">
    `student`.`student`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=student&table=tata">
    `student`.`tata`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=student&table=dataa">
    `student`.`dataa`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=student&table=prof">
    `student`.`prof`
  </a>
</li>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.c3R1ZGVudA==" data-vpath="cm9vdA==.c3R1ZGVudA==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=student"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=student" title="Structure">student</a>
  ...
  <li class="last database">
    ...
    <div class="clearfloat"></div>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;student&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="21585d667567593e7d722b464f4e3354">
  ...
  <ol class="breadcrumb breadcrumb-navbar">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="127.0.0.1" draggable="false">
        ...
        <a href="index.php?route=/database/structure&db=student" data-raw-text="student" draggable="false">
          Database:          student
        </a>
      </li>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap" href="index.php?route=/database/structure&db=student">
              <img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure
                              <span class="visually-hidden">(current)</span>
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/sql&db=student">
              <img src="themes/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/search&db=student">
              <img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_search">&nbsp;Search
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/multi-table-query&db=student">
              <img src="themes/dot.gif" title="Query" alt="Query" class="icon ic_s_db">&nbsp;Query
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/export&db=student">
              <img src="themes/dot.gif" title="Export" alt="Export" class="icon ic_b_export">&nbsp;Export
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/import&db=student">
              <img src="themes/dot.gif" title="Import" alt="Import" class="icon ic_b_import">&nbsp;Import
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/operations&db=student">
              <img src="themes/dot.gif" title="Operations" alt="Operations" class="icon ic_b_tblops">&nbsp;Operations
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/server/privileges&db=student&checkprivsdb=student&viewing_mode=db">
              <img src="themes/dot.gif" title="Privileges" alt="Privileges" class="icon ic_s_rights">&nbsp;Privileges
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/routines&db=student">
              <img src="themes/dot.gif" title="Routines" alt="Routines" class="icon ic_b_routines">&nbsp;Routines
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/events&db=student">
              <img src="themes/dot.gif" title="Events" alt="Events" class="icon ic_b_events">&nbsp;Events
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/triggers&db=student">
              <img src="themes/dot.gif" title="Triggers" alt="Triggers" class="icon ic_b_triggers">&nbsp;Triggers
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/tracking&db=student">
              <img src="themes/dot.gif" title="Tracking" alt="Tracking" class="icon ic_eye">&nbsp;Tracking
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/designer&db=student">
              <img src="themes/dot.gif" title="Designer" alt="Designer" class="icon ic_b_relations">&nbsp;Designer
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/central-columns&db=student">
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;student&amp;server&#x3D;1" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="token" value="21585d667567593e7d722b464f4e3354">
...
<input type="hidden" name="db" value="student"><input type="hidden" name="token" value="21585d667567593e7d722b464f4e3354">
<div class="table-responsive">
<table class="table table-striped table-hover table-sm w-auto data">
    <thead>
        <tr>
            <th class="d-print-none"></th>
            <th><a href="index.php?route=/database/structure&db=student&pos=0&sort=table&sort_order=DESC" title="Sort" onmouseover="$('.sort_arrow').toggle();" onmouseout="$('.sort_arrow').toggle();">Table <img src="themes/dot.gif" title="" alt="Ascending" class="icon ic_s_asc sort_arrow"> <img src="themes/dot.gif" title="" alt="Descending" class="icon ic_s_desc sort_arrow hide"></a></th>
            
                                                                                            <th colspan="7" class="d-print-none">
                Action            </th>
                        <th>
                <a href="index.php?route=/database/structure&db=student&pos=0&sort=records&sort_order=DESC" title="Sort">Rows</a>
                <span class="pma_hint"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_help"><span class="hide">May be approximate. Click on the number to get the exact count. See <a href="./doc/html/faq.html#faq3-11" target="documentation">FAQ 3.11</a>.</span></span>
                            ...
                            <th><a href="index.php?route=/database/structure&db=student&pos=0&sort=type&sort_order=ASC" title="Sort">Type</a></th>
                <th><a href="index.php?route=/database/structure&db=student&pos=0&sort=collation&sort_order=ASC" title="Sort">Collation</a></th>
            
                                            <th><a href="index.php?route=/database/structure&db=student&pos=0&sort=size&sort_order=DESC" title="Sort">Size</a></th>
                                <th><a href="index.php?route=/database/structure&db=student&pos=0&sort=overhead&sort_order=DESC" title="Sort">Overhead</a></th>
    ...
    <tbody>
            <tr id="row_tbl_1" data-filter-row="DATAA">
    ...
    <th>
        <a href="index.php?route=/sql&db=student&table=dataa&pos=0" title="">dataa</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="38af2bc7b0a4b94e48722c7fbd601ad4_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=student&ajax_request=1&favorite_table=dataa&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="a83db860f44b2ac4cb5aad1f8780720e">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=student&table=dataa&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=student&table=dataa">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=student&table=dataa">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
            ...
            <a href="index.php?route=/table/change&db=student&table=dataa"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=student&table=dataa&sql_query=TRUNCATE+%60dataa%60&message_to_show=Table%2Bdataa%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=student&table=dataa&reload=1&purge=1&sql_query=DROP+TABLE+%60dataa%60&message_to_show=Table+dataa+has+been+dropped.">
            ...
            data-table="dataa">
                ...
                <a href="index.php?route=/table/structure&db=student&table=dataa#showusage">
            ...
            <tr id="row_tbl_2" data-filter-row="EMPLOYEE">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=student&table=employee&pos=0" title="">employee</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="fa5473530e4d1a5a1e1eb53d2fedb10c_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=student&ajax_request=1&favorite_table=employee&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="e997888b01b38828e0283c70a91c36d5">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=student&table=employee&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=student&table=employee">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=student&table=employee">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=student&table=employee"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=student&table=employee&sql_query=TRUNCATE+%60employee%60&message_to_show=Table%2Bemployee%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=student&table=employee&reload=1&purge=1&sql_query=DROP+TABLE+%60employee%60&message_to_show=Table+employee+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="employee">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=student&table=employee#showusage">
            ...
            <tr id="row_tbl_3" data-filter-row="EXAM">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=student&table=exam&pos=0" title="">exam</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="654816f85dfe2115674e7115c7d1ea51_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=student&ajax_request=1&favorite_table=exam&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="de8b1104547c42e8b57b6c2e7f4ddc95">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=student&table=exam&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=student&table=exam">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=student&table=exam">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=student&table=exam"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=student&table=exam&sql_query=TRUNCATE+%60exam%60&message_to_show=Table%2Bexam%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=student&table=exam&reload=1&purge=1&sql_query=DROP+TABLE+%60exam%60&message_to_show=Table+exam+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="exam">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=student&table=exam#showusage">
                    <span>32.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_4" data-filter-row="PERSON">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=student&table=person&pos=0" title="">person</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="8b0a44048f58988b486bdd0d245b22a8_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=student&ajax_request=1&favorite_table=person&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="bf43e4e9246507283c575628ef2f2b48">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=student&table=person&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=student&table=person">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=student&table=person">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=student&table=person"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=student&table=person&sql_query=TRUNCATE+%60person%60&message_to_show=Table%2Bperson%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=student&table=person&reload=1&purge=1&sql_query=DROP+TABLE+%60person%60&message_to_show=Table+person+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="person">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=student&table=person#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_5" data-filter-row="PROF">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=student&table=prof&pos=0" title="">prof</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="d450c5dbcc10db0749277efc32f15f9f_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=student&ajax_request=1&favorite_table=prof&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="5597b2c2777db08d7a55bea16674c35f">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=student&table=prof&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=student&table=prof">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=student&table=prof">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=student&table=prof"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=student&table=prof&sql_query=TRUNCATE+%60prof%60&message_to_show=Table%2Bprof%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=student&table=prof&reload=1&purge=1&sql_query=DROP+TABLE+%60prof%60&message_to_show=Table+prof+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="prof">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=student&table=prof#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_6" data-filter-row="STUDENT">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=student&table=student&pos=0" title="">student</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="cd73502828457d15655bbd7a63fb0bc8_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=student&ajax_request=1&favorite_table=student&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="f5191470ec67cf0fa0cf5c2c6529eedc">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=student&table=student&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=student&table=student">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=student&table=student">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=student&table=student"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=student&table=student&sql_query=TRUNCATE+%60student%60&message_to_show=Table%2Bstudent%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=student&table=student&reload=1&purge=1&sql_query=DROP+TABLE+%60student%60&message_to_show=Table+student+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="student">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=student&table=student#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_7" data-filter-row="TATA">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=student&table=tata&pos=0" title="">tata</a>
        
    </th>
    
                <td class="text-center d-print-none">
                                    <a id="49d02d55ad10973b7b9d0dc9eba7fdf0_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=student&ajax_request=1&favorite_table=tata&add_favorite=1"
    title="Add to Favourites"
    data-favtargets="d32529184eff71f472f5ccc6eacfe9ee">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=student&table=tata&pos=0">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_b_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=student&table=tata">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=student&table=tata">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=student&table=tata"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql" data-post="db=student&table=tata&sql_query=TRUNCATE+%60tata%60&message_to_show=Table%2Btata%2Bhas%2Bbeen%2Bemptied.">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_b_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql" data-post="db=student&table=tata&reload=1&purge=1&sql_query=DROP+TABLE+%60tata%60&message_to_show=Table+tata+has+been+dropped.">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="tata">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=student&table=tata#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
...
<tr>
    ...
    <th class="tbl_num text-nowrap">
                ...
                <th colspan="7" class="d-print-none">Sum</th>
                                                <th class="value tbl_rows font-monospace text-end">58</th>
        ...
        <th>
                    ...
                    utf8mb4_general_ci
                                    ...
                                    <th class="value tbl_size font-monospace text-end">144.0 KiB</th>
    ...
    <label for="tablesForm_checkall">Check all</label>
        ...
        <option value="export">Export</option>
            ...
            <optgroup label="Table maintenance">
                <option value="analyze_tbl">Analyse table</option>
                <option value="check_tbl">Check table</option>
                <option value="checksum_tbl">Checksum table</option>
                <option value="optimize_tbl">Optimise table</option>
  ...
  <p class="d-print-none">
    ...
    <a href="index.php?route=/database/data-dictionary&db=student&goto=index.php%3Froute%3D%2Fdatabase%2Fstructure">
  ...
  <div class="card-body row row-cols-lg-auto g-3">
    ...
    <div class="col-12 align-self-lg-end">
      ...
      <a href="index.php?route=%2Fdatabase%2Fstructure&amp;db=student&amp;server=1" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer">
